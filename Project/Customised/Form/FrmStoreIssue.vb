            ...
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                ...
                If CType(AgL.VNull(DtV_TypeSettings.Rows(0)("IsPostedInStockProcess")), Boolean) Then
                    ...
                    mQry = "INSERT INTO StockProcess (DocId, Sr, V_Type, V_Prefix, " & _
                            ...
                            "Rate, Amount,NetAmount, Cost, LotNo, BaleNo, Process, ProdOrder, Remarks,CurrentStock) " & _
                            " VALUES (" & AgL.Chk_Text(mSearchCode) & ", " & _
                            " " & mSr & ", " & AgL.Chk_Text(TxtV_Type.AgSelectedValue) & ", " & AgL.Chk_Text(LblPrefix.Text) & ", " & _
                ...
                With DsTemp.Tables(0)
                    ...
                    If .Rows.Count > 0 Then
                        For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                            ...
                            Dgl1.Item(Col1Qty, I).Value = Format(AgL.VNull(.Rows(I)("Qty_Iss")), "0.".PadRight(AgL.VNull(.Rows(I)("QtyDecimalPlaces")) + 2, "0"))
                            ...
                            Dgl1.Item(Col1TotalMeasure, I).Value = Format(AgL.VNull(.Rows(I)("Measure_Iss")), "0.".PadRight(AgL.VNull(.Rows(I)("MeasureDecimalPlaces")) + 2, "0"))
