...
Public Class FrmJobEstimate
    ...
    Public Sub New(ByVal StrUPVar As String, ByVal DTUP As DataTable)
        ...
        EntryNCat = ClsMain.Temp_NCat.ServiceQuotation
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.LblV_Date.Location = New System.Drawing.Point(7, 37)
        ...
        Me.TxtV_Date.Location = New System.Drawing.Point(127, 36)
        Me.TxtV_Date.TabIndex = 2
        Me.TxtV_Date.Tag = ""
        '
        'LblV_Type
        '
        Me.LblV_Type.Location = New System.Drawing.Point(233, 18)
        ...
        'LblSite_CodeReq
        '
        Me.LblSite_CodeReq.Location = New System.Drawing.Point(110, 22)
        Me.LblSite_CodeReq.Tag = ""
        '
        'LblSite_Code
        '
        Me.LblSite_Code.BackColor = System.Drawing.Color.Transparent
        Me.LblSite_Code.Location = New System.Drawing.Point(7, 17)
        ...
        Me.TxtSite_Code.Location = New System.Drawing.Point(127, 16)
        ...
        Me.TxtSaleToParty.Location = New System.Drawing.Point(571, 35)
        Me.TxtSaleToParty.MaxLength = 0
        Me.TxtSaleToParty.Name = "TxtSaleToParty"
        Me.TxtSaleToParty.Size = New System.Drawing.Size(370, 18)
        ...
        Me.LblBuyer.Location = New System.Drawing.Point(512, 35)
        ...
        Me.TxtSalesTaxGroupParty.Location = New System.Drawing.Point(828, 15)
        Me.TxtSalesTaxGroupParty.MaxLength = 20
        Me.TxtSalesTaxGroupParty.Name = "TxtSalesTaxGroupParty"
        Me.TxtSalesTaxGroupParty.Size = New System.Drawing.Size(142, 18)
        ...
        Me.LblReferenceNo.Location = New System.Drawing.Point(233, 37)
        ...
        Me.LblTableReq.Location = New System.Drawing.Point(110, 62)
        ...
        Me.TxtJobcard.Location = New System.Drawing.Point(127, 56)
        ...
        Me.LblTable.Location = New System.Drawing.Point(7, 57)
        ...
        Me.TxtModel.Location = New System.Drawing.Point(571, 15)
        Me.TxtModel.MaxLength = 0
        Me.TxtModel.Name = "TxtModel"
        Me.TxtModel.Size = New System.Drawing.Size(137, 18)
        ...
        Me.Label10.Location = New System.Drawing.Point(233, 56)
        ...
        Me.LblHelp.Location = New System.Drawing.Point(244, 150)
        Me.LblHelp.Name = "LblHelp"
        Me.LblHelp.Size = New System.Drawing.Size(151, 16)
        Me.LblHelp.TabIndex = 3008
        Me.LblHelp.Text = "S -Spare  L - Labour"
        ...
        Me.TxtServiceTaxOnModelYN.Location = New System.Drawing.Point(571, 59)
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        If bSelectionQry <> "" Then
            mQry = "Insert Into SaleQuotationDetail(DocId, Sr, SaleChallan, SaleChallanSr, Item, SalesTaxGroupItem, " & _
                ...
                With DsTemp.Tables(0)
                    ...
                    If .Rows.Count > 0 Then
                        For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                            ...
                            If Dgl1.Item(Col1SaleChallan, I).Value <> "" Then
                    ...
                    If e.KeyCode <> Keys.Enter Then
                        If sender.AgHelpDataset Is Nothing Then
                            mQry = " SELECT H.DocId, H.ManualRefNo AS Jobcard_No, IU.Item_UID AS Vehicle_No, I.Description AS Model_Name, H.CostCenter   " & _
                                    ...
                                    " And H.DocId Not In (Select Service_JobCard From SaleQuotation Where DocId <> '" & mSearchCode & "') " & _
    ...
    Private Sub DGL1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Dgl1.KeyDown
        ...
        If Dgl1.CurrentCell IsNot Nothing Then
            If e.KeyCode = Keys.S Or e.KeyCode = Keys.L Then
    ...
    Private Sub PrintDocument(ByVal SearchCode As String)
        ...
        Try
            RepName = "SaleQuotation_Print" : RepTitle = "Material Issue Slip"
            ...
            mQry = " SELECT H.DocID, H.V_Type, H.V_Prefix, H.V_Date, H.V_No, H.Div_Code, H.Site_Code, H.ReferenceNo, H.SaleToParty, " & _
                        ...
                        " FROM (SELECT * FROM SaleQuotation WHERE DocId = '" & mSearchCode & "') As H  " & _
                        " LEFT JOIN (SELECT * FROM SaleQuotationDetail WHERE DocId = '" & mSearchCode & "') AS  L  ON H.DocID = L.DocId " & _
        ...
        Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
            Case Col1Item
                mQry = "SELECT H.Code, H.Description as Item_Name, H.ManualCode as Item_No, H.Unit, " & _
                        " H.Rate, U.DecimalPlaces as QtyDecimalPlaces, H.SalesTaxPostingGroup " & _
                        " FROM Item H " & _
    ...
    Private Sub FPrintInvoice()
        ...
        Dim I As Integer = 0
        Try
            mQry = "SELECT H.DocID, H.V_Type, H.V_Prefix, H.V_Date, H.V_No, H.Div_Code, H.Site_Code, H.ReferenceNo, H.Godown, H.Vendor, " & _
                        " H.SaleToParty, H.SaleToPartyName, H.SaleToPartyAddress, H.SaleToPartyCity, H.SaleToPartyMobile, H.SaleToPartyTinNo,  " & _
                        " H.SaleToPartyCstNo, H.ShipToParty, H.ShipToPartyName, H.ShipToPartyAddress, H.ShipToPartyCity, H.ShipToPartyMobile,  " & _
                        " H.SaleOrder, H.SaleChallan, H.Currency, H.SalesTaxGroupParty, H.Structure, H.BillingType, H.Form, H.FormNo, H.Transporter,  " & _
                        " H.Vehicle, H.VehicleDescription, H.Driver, H.DriverName, H.DriverContactNo, H.LrNo, H.LrDate, H.PrivateMark,  " & _
                        " H.PortOfLoading, H.DestinationPort, H.FinalPlaceOfDelivery, H.PreCarriageBy, H.PlaceOfPreCarriage, H.ShipmentThrough,  " & _
                        " H.CreditDays, H.ReferenceDocId, H.Remarks, H.TotalQty, H.TotalMeasure, H.TotalAmount, H.EntryBy, H.EntryDate,  " & _
                        " H.EntryType, H.EntryStatus, H.ApproveBy, H.ApproveDate, H.MoveToLog, H.MoveToLogDate, H.IsDeleted, H.Status, H.UID,  " & _
                        " H.TableCode, H.PaymentMode, H.PostingAc, H.Gross_Amount, H.Discount_Pre_Tax_Per, H.Discount_Pre_Tax,  " & _
                        " H.Other_Additions_Pre_Tax_Per, H.Other_Additions_Pre_Tax, H.Sales_Tax_Taxable_Amt, H.Vat_Per, H.Vat, H.Sat_Per, H.Sat,  " & _
                        " H.Discount_Per, H.Discount, H.Other_Charges_Per, H.Other_Charges, H.Round_Off, H.Net_Amount, H.Landed_Value,  " & _
                        " H.CustomFields, H.CreditLimit, H.InvoiceType, H.EnftryBy, H.SaleToPartyAdd1, H.SaleToPartyAdd2, H.PriceMode,  " & _
                        " H.CircularNo, H.CircularDate, H.DescriptionOfGoods, H.PackingMaterialDescription, H.NoOfKindsOfPkgs,  " & _
                        " H.TransportInformation, H.Compositions, H.OtherReference, H.TermsOfSale, H.NotifyParty, H.OrderNo, H.OrderDate,  " & _
                        " H.TotalDeliveryMeasure, H.TotalBale, H.GrossWeight, H.NetWeight, H.ManualInvoiceTotal, H.BaleNoStr, H.Freight_Per,  " & _
                        " H.Freight, H.InvoiceGenType, H.SaleToPartyCityName, H.Supplier, H.BillToParty, H.Service_JobCard, " & _
                        ...
                        " L.ReferenceDocId, L.LotNo, L.UID, L.Gross_Amount, L.Discount_Pre_Tax_Per, L.Discount_Pre_Tax,  " & _
                        " L.Other_Additions_Pre_Tax_Per, L.Other_Additions_Pre_Tax, L.Sales_Tax_Taxable_Amt, L.Vat_Per, L.Vat, L.Sat_Per, L.Sat,  " & _
                        " L.Discount_Per, L.Discount, L.Other_Charges_Per, L.Other_Charges, L.Round_Off, L.Net_Amount, L.Landed_Value, L.BaleNo,  " & _
                        " L.Remark, L.BillingType, L.Item_UID, L.ItemInvoiceGroup, L.DeliveryMeasure, L.DeliveryMeasurePerPcs,  " & _
                        " L.TotalDeliveryMeasure, L.Freight_Per, L.Freight, L.DeliveryMeasureMultiplier, L.RateType, L.SaleQuotation,  " & _
                        " L.SaleQuotationSr, L.Supplier, L.RatePerQty, L.RatePerMeasure, L.Size, L.DontPostInStock, Sg.Name AS BillToPartyName, " & _
                        ...
                        " WHERE H.DocID = '" & mSearchCode & "'"
            ClsMain.FPrintThisDocument(Me, TxtV_Type.Tag, mQry, "SaleQuotation_Print", "Tax Invoice")
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
