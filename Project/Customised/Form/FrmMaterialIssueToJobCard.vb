...
Public Class FrmMaterialIssueToJobCard
    ...
    Protected Const Col1SaleChallanSr As String = "SaleChallanSr"

    Private Const TransactionType_Issue = "Issue"
    Private Const TransactionType_Return = "Return"
    ...
    Public Sub New(ByVal StrUPVar As String, ByVal DTUP As DataTable)
        ...
        Me.EntryNCat = ClsMain.Temp_NCat.ServiceMaterialIssue
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.TxtSubgroup = New AgControls.AgTextBox()
        ...
        Me.TP1.Controls.Add(Me.TxtSubgroup)
        ...
        Me.TP1.Controls.SetChildIndex(Me.TxtSubgroup, 0)
        ...
        'TxtSubgroup
        '
        Me.TxtSubgroup.AgAllowUserToEnableMasterHelp = False
        Me.TxtSubgroup.AgLastValueTag = Nothing
        Me.TxtSubgroup.AgLastValueText = Nothing
        Me.TxtSubgroup.AgMandatory = True
        Me.TxtSubgroup.AgMasterHelp = False
        Me.TxtSubgroup.AgNumberLeftPlaces = 8
        Me.TxtSubgroup.AgNumberNegetiveAllow = False
        Me.TxtSubgroup.AgNumberRightPlaces = 2
        Me.TxtSubgroup.AgPickFromLastValue = False
        Me.TxtSubgroup.AgRowFilter = ""
        Me.TxtSubgroup.AgSearchMethod = AgControls.AgLib.TxtSearchMethod.Simple
        Me.TxtSubgroup.AgSelectedValue = Nothing
        Me.TxtSubgroup.AgTxtCase = AgControls.AgTextBox.TxtCase.None
        Me.TxtSubgroup.AgValueType = AgControls.AgTextBox.TxtValueType.Text_Value
        Me.TxtSubgroup.BorderStyle = System.Windows.Forms.BorderStyle.None
        Me.TxtSubgroup.Font = New System.Drawing.Font("Arial", 11.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.TxtSubgroup.Location = New System.Drawing.Point(363, 69)
        Me.TxtSubgroup.MaxLength = 100
        Me.TxtSubgroup.Name = "TxtSubgroup"
        Me.TxtSubgroup.Size = New System.Drawing.Size(393, 18)
        Me.TxtSubgroup.TabIndex = 6
        '
        'LblSteward
        '
        ...
        Me.LblSteward.Location = New System.Drawing.Point(226, 70)
        Me.LblSteward.Name = "LblSteward"
        Me.LblSteward.Size = New System.Drawing.Size(116, 16)
        Me.LblSteward.TabIndex = 738
        Me.LblSteward.Text = "Issue to Employee"
        '
        'LblReferenceNoReq
        '
        ...
        Me.TxtRemarks.Location = New System.Drawing.Point(363, 109)
        ...
        Me.LblRemarks.Location = New System.Drawing.Point(226, 110)
        ...
        Me.Label1.Location = New System.Drawing.Point(344, 77)
        Me.Label1.Name = "Label1"
        Me.Label1.Size = New System.Drawing.Size(10, 7)
        Me.Label1.TabIndex = 756
        Me.Label1.Text = "Ä"
        '
        'TxtVehicleNo
        '
        ...
        Me.TxtFromGodown.Location = New System.Drawing.Point(363, 89)
        Me.TxtFromGodown.MaxLength = 100
        Me.TxtFromGodown.Name = "TxtFromGodown"
        Me.TxtFromGodown.Size = New System.Drawing.Size(393, 18)
        Me.TxtFromGodown.TabIndex = 7
        '
        'Label6
        '
        ...
        Me.Label6.TabIndex = 762
        Me.Label6.Text = "From Godown"
        '
        'LblHelp
        '
        ...
        Me.Name = "FrmMaterialIssueToJobCard"
    ...
    Protected WithEvents TxtSubgroup As AgControls.AgTextBox
...
#End Region
    ...
    Private Sub FrmMaterialIssueToJobCard_BaseEvent_ApproveDeletion_InTrans(SearchCode As String, Conn As SqlClient.SqlConnection, Cmd As SqlClient.SqlCommand) Handles Me.BaseEvent_ApproveDeletion_InTrans
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1TransactionType, 50, 0, Col1TransactionType, True, True)
            ...
            .AddAgTextColumn(Dgl1, Col1SaleChallan, 120, 0, Col1SaleChallan, False, True)
            .AddAgTextColumn(Dgl1, Col1Remarks, 130, 0, Col1Remarks, True, False)
            .AddAgTextColumn(Dgl1, Col1SaleChallanSr, 120, 0, Col1SaleChallanSr, False, True)
        End With
    ...
    Private Sub FrmSaleOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = "  Update SaleChallan " & _
                ...
                " IssueToSubCode = " & AgL.Chk_Text(TxtSubgroup.Tag) & ", " & _
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                ...
                If Dgl1.Item(Col1SaleChallan, I).Tag = "" Then
                    Dgl1.Item(Col1SaleChallan, I).Tag = mSearchCode
                    Dgl1.Item(Col1SaleChallanSr, I).Value = mSr
                End If


                If AgL.StrCmp(Dgl1.Item(Col1TransactionType, I).Value, TransactionType_Return) Then
                    Dgl1.Item(Col1Qty, I).Value = -Math.Abs(Val(Dgl1.Item(Col1Qty, I).Value))
                End If

                mQry = "Insert Into SaleChallanDetail(DocId, Sr, SubCode, TransactionType, Item, ChargeType, " & _
                        ...
                        " " & AgL.Chk_Text(TxtSubgroup.Tag) & ", " & _
                        " " & AgL.Chk_Text(Dgl1.Item(Col1TransactionType, I).Value) & ", " & _
                ...
                Dim bQty_Iss As Double = 0, bQty_Rec As Double = 0
                If Val(Dgl1.Item(Col1Qty, I).Value) > 0 Then
                    bQty_Iss = Val(Dgl1.Item(Col1Qty, I).Value)
                    bQty_Rec = 0
                Else
                    bQty_Iss = 0
                    bQty_Rec = Math.Abs(Val(Dgl1.Item(Col1Qty, I).Value))
                End If

                mQry = "INSERT INTO Stock (DocId, Sr, V_Type, V_Prefix, " & _
                        " V_Date, V_No, RecID, Div_Code, " & _
                        " Site_Code, SubCode, Item, Godown, " & _
                        " Qty_Iss, Qty_Rec, Unit, Measure_Iss, Measure_Rec, MeasureUnit, " & _
                        " Remarks, CostCenter, EType_IR, Rate, Amount, Landed_Value) " & _
                        " VALUES (" & AgL.Chk_Text(mSearchCode) & ", " & mSr & ", " & AgL.Chk_Text(TxtV_Type.AgSelectedValue) & ", " & AgL.Chk_Text(LblPrefix.Text) & ", " & _
                        " " & AgL.Chk_Text(TxtV_Date.Text) & ", " & Val(TxtV_No.Text) & ", " & AgL.Chk_Text(TxtReferenceNo.Text) & ", " & AgL.Chk_Text(TxtDivision.AgSelectedValue) & ", " & _
                        " " & AgL.Chk_Text(TxtSite_Code.AgSelectedValue) & ", " & AgL.Chk_Text(TxtSubgroup.Tag) & ", " & AgL.Chk_Text(Dgl1.AgSelectedValue(Col1Item, I)) & ", " & AgL.Chk_Text(TxtFromGodown.AgSelectedValue) & ", " & _
                        " " & Val(bQty_Iss) & ", " & Val(bQty_Rec) & ", " & AgL.Chk_Text(Dgl1.Item(Col1Unit, I).Value) & ",  " & _
                        " " & Val(bQty_Iss) & ", " & Val(bQty_Rec) & ", " & AgL.Chk_Text(Dgl1.Item(Col1Unit, I).Value) & ",  " & _
                        " " & AgL.Chk_Text(Dgl1.Item(Col1Remarks, I).Value) & ", " & AgL.Chk_Text(TxtCostCenter.Text) & ", " & _
                        " 'I', " & Val(Dgl1.Item(Col1Rate, I).Value) & ", " & _
                        " " & Val(Dgl1.Item(Col1Amount, I).Value) & ", " & _
                        " " & Val(Dgl1.Item(Col1Amount, I).Value) & " " & _
                        " ) "
                AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
    ...
    Private Sub FrmSaleOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                TxtSubgroup.Tag = AgL.XNull(.Rows(0)("IssueToSubCode"))
                TxtSubgroup.Text = AgL.XNull(.Rows(0)("IssueToSubCodeName"))

                TxtSubgroup.AgLastValueTag = TxtSubgroup.Tag
                TxtSubgroup.AgLastValueText = TxtSubgroup.Text

                TxtCostCenter.Text = AgL.XNull(.Rows(0)("CostCenter"))
                TxtFromGodown.Tag = AgL.XNull(.Rows(0)("Godown"))
                TxtFromGodown.Text = AgL.XNull(.Rows(0)("Godown_Name"))
                ...
                mQry = "Select L.*, I.Description as Item_Name, I.ManualCode as Item_Code, " & _
                        " U.DecimalPlaces as QtyDecimalPlaces, Sc.V_Type + '-' +  Sc.ReferenceNo As SaleChallanNo  " & _
    ...
    Private Sub FrmSaleOrder_BaseEvent_Topctrl_tbAdd() Handles Me.BaseEvent_Topctrl_tbAdd
        ...
        TxtSubgroup.Tag = IIf(TxtSubgroup.AgLastValueTag Is Nothing, "", TxtSubgroup.AgLastValueTag)
        TxtSubgroup.Text = IIf(TxtSubgroup.AgLastValueText Is Nothing, "", TxtSubgroup.AgLastValueText)

        Try
            Dgl1.Item(Col1TransactionType, 0).Value = TransactionType_Issue
        Catch ex As Exception
        End Try
        ...
        Try
            ...
            Else
                If Dgl1.AgDataRow IsNot Nothing Then
                    ...
                    Dgl1.Item(Col1SaleChallanSr, mRow).Value = AgL.VNull(Dgl1.AgDataRow.Cells("SaleChallanSr").Value)
            ...
            Case Col1ItemCode
                Try
                    If Dgl1.Item(Col1TransactionType, e.RowIndex).Value = "" Then
                        Dgl1.Item(Col1TransactionType, e.RowIndex).Value = TransactionType_Issue
                    End If
    ...
    Private Sub FrmSaleOrder_BaseFunction_Calculation() Handles Me.BaseFunction_Calculation
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                ...
                If AgL.StrCmp(Dgl1.Item(Col1TransactionType, I).Value, TransactionType_Issue) Then
    ...
    Private Sub FrmSaleOrder_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        If AgL.RequiredField(TxtSubgroup, LblSteward.Text) Then passed = False : Exit Sub
                ...
                If .Item(Col1Item, I).Value <> "" Then
                    ...
                    If AgL.StrCmp(Dgl1.Item(Col1TransactionType, I).Value, TransactionType_Return) Then
                        mQry = " Select IsNull(Sum(Qty), 0)  " & _
                                ...
                                " AND L.SaleChallan = '" & Dgl1.Item(Col1SaleChallan, I).Tag & "' " & _
                                " AND L.SaleChallanSr = " & Val(Dgl1.Item(Col1SaleChallanSr, I).Value) & "" & _
    ...
    Private Sub DGL1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Dgl1.KeyDown
        ...
        If Dgl1.CurrentCell IsNot Nothing Then
            If e.KeyCode = Keys.I Or e.KeyCode = Keys.R Then
                If Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name = Col1TransactionType Then
                    If Dgl1.Item(Col1Item, Dgl1.CurrentCell.RowIndex).Value = "" Then
                        If e.KeyCode = Keys.I Then
                            Dgl1.Item(Col1TransactionType, Dgl1.CurrentCell.RowIndex).Value = TransactionType_Issue
                        ElseIf e.KeyCode = Keys.R Then
                            Dgl1.Item(Col1TransactionType, Dgl1.CurrentCell.RowIndex).Value = TransactionType_Return
                        End If
    ...
    Private Sub FCreateHelpSubgroup()
        ...
        TxtSubgroup.AgHelpDataSet(0, TabControl1.Top + TP1.Top, TabControl1.Left + TP1.Left) = AgL.FillData(mQry, AgL.GCn)
    End Sub
    ...
    Private Sub FCreateHelpItem()
        ...
        Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
            Case Col1Item
                If AgL.StrCmp(Dgl1.Item(Col1TransactionType, Dgl1.CurrentCell.RowIndex).Value, TransactionType_Return) Then
                    mQry = " SELECT Max(L.Item) As Code,  " & _
                            " Max(I.Description) As Item_Name,    " & _
                            " Max(I.ManualCode) As Item_No,    " & _
                            ...
                            " Max(Mu.DecimalPlaces) As MeasureDecimalPlaces, " & _
                            " Max(L.ChargeType) As ChargeTypeCode, " & _
                            " Max(L.ChargeType) As ChargeType, " & _
                            " L.SaleChallan, L.SaleChallanSr       " & _
                            " FROM (      " & _
                            " 	 SELECT DocID, V_Type, ReferenceNo, V_Date   " & _
                            " 	 FROM SaleChallan With (nolock)       " & _
                            " 	 WHERE Service_JobCard = '" & TxtJobcard.Tag & "'       " & _
                            " 	 And Div_Code = '" & TxtDivision.Tag & "'       " & _
                            " 	 AND Site_Code = '" & TxtSite_Code.Tag & "'       " & _
                            " 	 AND V_Date <= '" & TxtV_Date.Text & "'   " & _
                            " 	 AND DocId <> '" & mSearchCode & "'    " & _
                            " ) H       " & _
                            " LEFT JOIN SaleChallanDetail L With (nolock) ON H.DocID = L.DocId    " & _
                            ...
                            " LEFT JOIN Service_ChargeType C On L.ChargeType = C.Code " & _
    ...
    Private Sub TxtFromGodown_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtFromGodown.KeyDown, TxtSubgroup.KeyDown, TxtJobcard.KeyDown
        Select Case sender.Name
