...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.LblDescription.Location = New System.Drawing.Point(189, 79)
        Me.LblDescription.Name = "LblDescription"
        Me.LblDescription.Size = New System.Drawing.Size(82, 16)
        Me.LblDescription.TabIndex = 661
        Me.LblDescription.Text = "Model Group"
        '
        'TxtItemCategory
        '
...
#End Region
    ...
    Public Overridable Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        Dim mConStr$ = ""
        mConStr = " Where I.ItemType = '" & ClsMain.ItemType.Model & "'"
        AgL.PubFindQry = "SELECT I.Code, I.Description as Item_Group, C.Description as Item_Category  " & _
                        " FROM ItemGroup I  " & _
                        " Left Join ItemCategory C On I.ItemCategory = C.Code " & mConStr
    ...
    Private Sub FrmQuality1_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        mQry = "Select Code, Description As Name " & _
                " From ItemGroup " & _
                " Where ItemType = '" & ClsMain.ItemType.Model & "' " & _
    ...
    Private Function FGetRelationalData() As Boolean
        Try
            ...
            If AgL.VNull(AgL.Dman_Execute(mQry, AgL.GcnRead).ExecuteScalar) > 0 Then
                MsgBox("Models Exists For This Model Group In Model Master.Can't Delete...!", MsgBoxStyle.Information)
                FGetRelationalData = True
                Exit Function
            End If
        Catch ex As Exception
            MsgBox(ex.Message & " In FGetRelationalData In Model Group")
            FGetRelationalData = True
        End Try
    End Function
