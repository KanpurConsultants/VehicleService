...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.TxtSalesTaxPostingGroup.Location = New System.Drawing.Point(334, 154)
        ...
        Me.LblSalesTaxPostingGroup.Location = New System.Drawing.Point(211, 155)
        ...
        Me.TxtReorderLevel.Location = New System.Drawing.Point(578, 134)
        ...
        Me.LblReorderLevel.Location = New System.Drawing.Point(467, 135)
...
#End Region
    ...
    Private Sub FrmYarn_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        Dim mConStr$ = ""
        mConStr = " Where ItemType = '" & ClsMain.ItemType.Parts & "'"
    ...
    Public Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        Dim mConStr$ = ""
        mConStr = " Where I.ItemType = '" & ClsMain.ItemType.Parts & "'"
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "UPDATE Item " & _
                ...
                " ItemType = " & AgL.Chk_Text(ClsMain.ItemType.Parts) & ", " & _
    ...
    Private Sub FrmQuality1_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        mQry = "Select Code, ManualCode As ItemCode, Div_Code ,ItemType " & _
                " From Item Where ItemType = '" & ClsMain.ItemType.Parts & "'" & _
                " Order By ManualCode "
                ...
                Case TxtItemGroup.Name
                    If TxtItemGroup.AgHelpDataSet Is Nothing Then
                        If e.KeyCode <> Keys.Enter Then
                            mQry = " Select I.Code As Code, I.Description As ItemGroup, I.ItemCategory, I.ItemType From ItemGroup I Where ItemType = '" & ClsMain.ItemType.Parts & "' "
    ...
    Private Sub TxtItemCategory_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtSalesTaxPostingGroup.KeyDown
        If e.KeyCode = Keys.Enter Then
