...
Public Class FrmServiceQuotationAmendment
    ...
    Public Sub New(ByVal StrUPVar As String, ByVal DTUP As DataTable)
        ...
        EntryNCat = ClsMain.Temp_NCat.ServiceQuotationAmendment
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.TxtJobcard.Size = New System.Drawing.Size(124, 18)
        ...
        Me.LblHelp.Location = New System.Drawing.Point(828, 150)
        ...
        Me.BtnFillSaleOrder.Location = New System.Drawing.Point(519, 152)
        Me.BtnFillSaleOrder.Margin = New System.Windows.Forms.Padding(0)
        Me.BtnFillSaleOrder.Name = "BtnFillSaleOrder"
        Me.BtnFillSaleOrder.Size = New System.Drawing.Size(39, 18)
        ...
        Me.Name = "FrmServiceQuotationAmendment"
...
#End Region
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                If Dgl1.Item(ColSNo, I).Tag Is Nothing And Dgl1.Rows(I).Visible = True Then
                    mSr += 1
                    mSaleQuotationSr = AgL.VNull(AgL.Dman_Execute("Select Max(Sr) From SaleQuotationDetail With (NoLock) Where DocID = '" & Dgl1.Item(Col1SaleQuotation, I).Tag & "'", AgL.GcnRead).ExecuteScalar) + 1

                    If Val(Dgl1.Item(Col1SaleQuotationSr, I).Value) = 0 Then
                        mQry = "Insert Into SaleQuotationDetail(DocId, Sr, GenDocId, GenDocIdSr, Item, SalesTaxGroupItem, " & _
                                " Qty, Unit, Rate, Amount, Remark, ServiceTaxOnModelYN, ServiceTaxYN, SaleQuotation, SaleQuotationSr, " & AgCalcGrid1.FLineTableFieldNameStr() & ") " & _
                                " Values(" & AgL.Chk_Text(Dgl1.Item(Col1SaleQuotation, I).Tag) & ", " & Val(mSaleQuotationSr) & ", " & _
                                ...
                                " " & AgL.Chk_Text(Dgl1.Item(Col1SaleQuotation, I).Tag) & ", " & _
                                " " & AgL.Chk_Text(mSaleQuotationSr) & ", " & _
                                " " & AgCalcGrid1.FLineTableFieldValuesStr(I) & ") "
                        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)

                        Dgl1.Item(Col1SaleQuotationSr, I).Value = mSaleQuotationSr
                    End If
                    ...
                    mQry = "Insert Into SaleQuotationDetail(DocId, Sr, Item, SalesTaxGroupItem, " & _
                            ...
                            " " & AgL.Chk_Text(Dgl1.Item(Col1ServiceTaxYN, I).Value) & ", " & _
                            " " & AgL.Chk_Text(Dgl1.Item(Col1SaleQuotation, I).Tag) & ", " & _
                            " " & AgL.Chk_Text(Dgl1.Item(Col1SaleQuotationSr, I).Value) & ", " & _
                            " " & AgCalcGrid1.FLineTableFieldValuesStr(I) & ") "
                    AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                Else
                    If Dgl1.Rows(I).Visible = True Then
                        mQry = " UPDATE SaleQuotationDetail " & _
                                    ...
                                    " SaleQuotation = " & AgL.Chk_Text(Dgl1.Item(Col1SaleQuotation, I).Tag) & ", " & _
                                    " SaleQuotationSr = " & AgL.Chk_Text(Dgl1.Item(Col1SaleQuotationSr, I).Value) & ", " & _
                    ...
                    Else
                        ...
                        mQry = " Delete From SaleQuotationDetail Where GenDocId = '" & mSearchCode & "' And GenDocIDSr = " & Dgl1.Item(ColSNo, I).Tag & "  "
                        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                    End If
                End If
            End If
        ...
        Try
            ...
            Else
                If Dgl1.AgDataRow IsNot Nothing Then
                    ...
                    Dgl1.Item(Col1SaleQuotation, mRow).Tag = AgL.XNull(Dgl1.AgDataRow.Cells("SaleQuotation").Value)
                    Dgl1.Item(Col1SaleQuotation, mRow).Value = AgL.XNull(Dgl1.AgDataRow.Cells("SaleQuotationNo").Value)
                    Dgl1.Item(Col1SaleQuotationSr, mRow).Value = AgL.XNull(Dgl1.AgDataRow.Cells("SaleQuotationSr").Value)
                    Dgl1.Item(Col1SaleQuotationSr, mRow).Value = AgL.XNull(Dgl1.AgDataRow.Cells("SaleQuotationSr").Value)
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub FrmSaleQuotation_BaseEvent_Topctrl_tbRef() Handles Me.BaseEvent_Topctrl_tbRef
        If Dgl1.AgHelpDataSet(Col1Item) IsNot Nothing Then Dgl1.AgHelpDataSet(Col1Item).Dispose() : Dgl1.AgHelpDataSet(Col1Item) = Nothing
        If Dgl1.AgHelpDataSet(Col1SaleQuotation) IsNot Nothing Then Dgl1.AgHelpDataSet(Col1SaleQuotation).Dispose() : Dgl1.AgHelpDataSet(Col1SaleQuotation) = Nothing
        If TxtJobcard.AgHelpDataSet IsNot Nothing Then TxtJobcard.AgHelpDataSet.Dispose() : TxtJobcard.AgHelpDataSet = Nothing
    ...
    Private Sub Dgl1_EditingControl_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Dgl1.EditingControl_KeyDown
        Try
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                ...
                Case Col1SaleQuotation
                    If Dgl1.AgHelpDataSet(Col1SaleQuotation) Is Nothing Then
                        mQry = " Select H.DocId As Code, H.V_Type + '-' + H.ReferenceNo As SaleQuotationNo From SaleQuotation H LEFT JOIN Voucher_Type Vt On H.V_Type = Vt.V_Type Where Vt.NCat = '" & ClsMain.Temp_NCat.ServiceQuotation & "' And H.Service_JobCard = '" & TxtJobcard.Tag & "'"
                        Dgl1.AgHelpDataSet(Col1SaleQuotation) = AgL.FillData(mQry, AgL.GCn)
                    End If
            End Select
        Catch ex As Exception
            MsgBox(ex.Message)
    ...
    Private Sub FCreateHelpItem()
        ...
        Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
            Case Col1Item
                If RbtQtyAmendment.Checked Then
                    mQry = " SELECT Max(I.Code) AS Code, " & _
                            " Max(I.Description) AS Item_Name, Max(I.ManualCode) AS Item_No, Max(L.Unit) AS Unit, " & _
                            " Max(H.V_Type + '-' + H.ReferenceNo) AS SaleQuotationNo, " & _
                            " Max(L.Rate) As Rate, Max(U.DecimalPlaces) as QtyDecimalPlaces, Max(L.SalesTaxGroupItem) SalesTaxPostingGroup, " & _
                            " IsNull(Max(L.ServiceTaxYN),'N') As ServiceTaxYN, " & _
                            " L.SaleQuotation, L.SaleQuotationSr " & _
                            " FROM SaleQuotationDetail L  " & _
                            " LEFT JOIN SaleQuotation H ON L.SaleQuotation = H.DocID " & _
                            ...
                            " And H.Service_JobCard = '" & TxtJobcard.Tag & "' " & _
                            " And I.ItemType = '" & Dgl1.Item(Col1ItemType, Dgl1.CurrentCell.RowIndex).Value & "'" & strCond & _
                            " GROUP BY L.SaleQuotation, L.SaleQuotationSr "
                    Dgl1.AgHelpDataSet(Dgl1.CurrentCell.ColumnIndex, 6) = AgL.FillData(mQry, AgL.GCn)
                Else
                    mQry = "SELECT I.Code, I.Description as Item_Name, I.ManualCode as Item_No, I.Unit, " & _
                            " I.Rate, U.DecimalPlaces as QtyDecimalPlaces, I.SalesTaxPostingGroup, IsNull(I.ServiceTaxYN,'N') As ServiceTaxYN, " & _
                            " Null AS SaleQuotationNo, Null As SaleQuotation, Null As SaleQuotationSr " & _
                            " FROM Item I " & _
                            " Left Join Unit U On I.Unit = U.Code " & _
                            " Where IsNull(I.Status,'" & AgTemplate.ClsMain.EntryStatus.Active & "')='" & AgTemplate.ClsMain.EntryStatus.Active & "' " & _
                            " And I.ItemType = '" & Dgl1.Item(Col1ItemType, Dgl1.CurrentCell.RowIndex).Value & "'" & strCond
                    Dgl1.AgHelpDataSet(Dgl1.CurrentCell.ColumnIndex, 8) = AgL.FillData(mQry, AgL.GCn)

                    Dgl1.Columns(Col1SaleQuotation).ReadOnly = False
                End If
            ...
            Case Col1ItemCode
                If RbtQtyAmendment.Checked Then
                    mQry = " SELECT Max(I.Code) AS Code, " & _
                            " Max(I.ManualCode) AS Item_No, Max(I.Description) AS Item_Name, Max(L.Unit) AS Unit, " & _
                            " Max(H.V_Type + '-' + H.ReferenceNo) AS SaleQuotationNo, " & _
                            " Max(L.Rate) As Rate, Max(U.DecimalPlaces) as QtyDecimalPlaces, Max(L.SalesTaxGroupItem) SalesTaxPostingGroup, " & _
                            " IsNull(Max(L.ServiceTaxYN),'N') As ServiceTaxYN, " & _
                            " L.SaleQuotation, L.SaleQuotationSr " & _
                    ...
                    Dgl1.AgHelpDataSet(Dgl1.CurrentCell.ColumnIndex, 6) = AgL.FillData(mQry, AgL.GCn)
                Else
                    mQry = "SELECT I.Code, I.ManualCode as Item_No, I.Description as Item_Name, I.Unit, " & _
                            " I.Rate, U.DecimalPlaces as QtyDecimalPlaces, I.SalesTaxPostingGroup, IsNull(I.ServiceTaxYN,'N') As ServiceTaxYN, " & _
                            " Null AS SaleQuotationNo, Null As SaleQuotation, Null As SaleQuotationSr " & _
                            " FROM Item I " & _
                            " Left Join Unit U On I.Unit = U.Code " & _
