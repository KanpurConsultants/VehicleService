...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.LblDescription.Text = "Labour Group"
        '
        'FrmLabourGroup
        '
...
#End Region
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "UPDATE ItemGroup " & _
                ...
                " ItemCategory = " & AgL.Chk_Text(ClsMain.ItemCategory.Labour) & ", " & _
    ...
    Private Sub FrmQuality1_BaseFunction_FIniList() Handles Me.BaseFunction_FIniList
        mQry = "Select Code, Description As Name " & _
                " From ItemGroup Where ItemType = '" & ClsMain.ItemType.Labour & "'" & _
        ...
        Try
            Select Case sender.NAME
                Case TxtDescription.Name
                    If MsgBox("Do yWWou want to save?", MsgBoxStyle.YesNo + MsgBoxStyle.DefaultButton1, "Save") = MsgBoxResult.Yes Then
