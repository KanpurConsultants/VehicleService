        ...
        Try
            ...
            mQry = " SELECT " & strGrpFld & " as GrpField, " & strGrpFldDesc & " as GrpFieldDesc, " & strGrpFldHead & " as GrpFieldHead, " & _
                   " H.DocID, H.V_Type, H.V_Date, " & _
                    ...
                    " L.Gross_Amount, L.Sales_Tax_Taxable_Amt, L.Vat, L.Sat, L.Discount, L.Other_Charges, L.Net_Amount, L.Round_Off , L.Landed_Value, L.Qty, L.Unit, L.TotalMeasure, L.MeasureUnit, Supplier.ManualCode as Supplier_Code, SO.ReferenceNo as SaleOrderNo  " & _
