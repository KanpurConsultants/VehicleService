        ...
        If IsEntryPoint Then
            Select Case StrSender
                ...
                Case MDI.MnuSaleInvoiceEntry.Name
                    FrmObj = New FrmSaleChallan(StrUserPermission, DTUP, ClsMain.ItemType.FinishedMaterial)
                    CType(FrmObj, FrmSaleChallan).FSetParameter(False, False, False, False, False, False, False, False, False, False, True, False, False, False, False)
                Case Else
                    FrmObj = Nothing
            End Select
        Else
