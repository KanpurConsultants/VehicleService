...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.TxtSupplier = New AgControls.AgTextBox
        ...
        Me.TP1.Controls.Add(Me.TxtSupplier)
        ...
        Me.TP1.Controls.SetChildIndex(Me.TxtSupplier, 0)
        '
        'Topctrl1
        '
        ...
        Me.RbtInvoiceForChallan.TabIndex = 2
        ...
        Me.RbtInvoiceForOrder.TabIndex = 1
        ...
        'TxtSupplier
        '
        Me.TxtSupplier.AgAllowUserToEnableMasterHelp = False
        Me.TxtSupplier.AgMandatory = True
        Me.TxtSupplier.AgMasterHelp = False
        Me.TxtSupplier.AgNumberLeftPlaces = 8
        Me.TxtSupplier.AgNumberNegetiveAllow = False
        Me.TxtSupplier.AgNumberRightPlaces = 2
        Me.TxtSupplier.AgPickFromLastValue = False
        Me.TxtSupplier.AgRowFilter = ""
        Me.TxtSupplier.AgSearchMethod = AgControls.AgLib.TxtSearchMethod.Simple
        Me.TxtSupplier.AgSelectedValue = Nothing
        Me.TxtSupplier.AgTxtCase = AgControls.AgTextBox.TxtCase.None
        Me.TxtSupplier.AgValueType = AgControls.AgTextBox.TxtValueType.Text_Value
        Me.TxtSupplier.BorderStyle = System.Windows.Forms.BorderStyle.None
        Me.TxtSupplier.Font = New System.Drawing.Font("Arial", 11.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.TxtSupplier.Location = New System.Drawing.Point(598, 45)
        Me.TxtSupplier.MaxLength = 0
        Me.TxtSupplier.Name = "TxtSupplier"
        Me.TxtSupplier.Size = New System.Drawing.Size(379, 18)
        ...
        Me.Label7.Location = New System.Drawing.Point(510, 45)
    ...
    Protected WithEvents TxtSupplier As AgControls.AgTextBox
...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1Size, 130, 0, Col1Size, True, False)
            ...
            .AddAgDateColumn(Dgl1, Col1ExpiryDate, 90, Col1Remark, True, False)
    ...
    Private Sub FrmSaleOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = " Update SaleInvoice " & _
                ...
                " Supplier = " & AgL.Chk_Text(TxtSupplier.Tag) & ", " & _
        ...
        mQry = "Insert Into SaleInvoiceDetail(DocId, Sr, SaleChallan, SaleChallanSr, SaleOrder, SaleOrderSr, Item_Uid, Item, Size, SalesTaxGroupItem, " & _
                " Qty, Unit, MeasurePerPcs, MeasureUnit, " & _
                " TotalMeasure, Rate, RatePerQty, RatePerMeasure, Amount, MRP, ExpiryDate, Remark, SaleInvoice, SaleInvoiceSr, BillingType, RateType, BaleNo, Supplier, DeliveryMeasure, DeliveryMeasureMultiplier, TotalDeliveryMeasure, " & AgCalcGrid1.FLineTableFieldNameStr() & ") "
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                ...
                bSelectionQry += " Select " & AgL.Chk_Text(mSearchCode) & ", " & mSr & ", " & _
                                    ...
                                    " " & AgL.Chk_Text(Dgl1.Item(Col1Size, I).Tag) & ", " & _
                                    ...
                                    " " & AgL.Chk_Text(TxtSupplier.Tag) & " , " & _
        ...
        mQry = " UPDATE SaleInvoice Set BaleNoStr = " & AgL.Chk_Text(TxtBaleNo.Text) & " Where DocId = '" & mSearchCode & "'"
        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
    ...
    Private Sub FrmSaleOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                TxtSupplier.Tag = AgL.XNull(.Rows(0)("Supplier"))
                TxtSupplier.Text = AgL.XNull(.Rows(0)("SupplierName"))
                ...
                If AgL.XNull(.Rows(0)("InvoiceGenType")) = InvoiceType_ForChallan Then
                    ...
                    RbtInvoiceDirect.Enabled = False
                    RbtInvoiceForOrder.Enabled = False
                Else
                    RbtInvoiceForChallan.Checked = False
                    RbtInvoiceDirect.Enabled = True
                    RbtInvoiceForOrder.Enabled = True
                End If
                ...
                mQry = "Select L.*, I.Description As ItemDesc, I.ManualCode, C.V_Type + '-' + C.ReferenceNo As ChallanRefNo, " & _
                        ...
                        " U.DecimalPlaces, U.DecimalPlaces as QtyDecimalPlaces, MU.DecimalPlaces as MeasureDecimalPlaces, S.Description As SizeDesc " & _
                        ...
                        " LEFT JOIN Rug_Size S With (NoLock) ON L.Size = S.Code " & _
            ...
            Else
                If Dgl1.AgDataRow IsNot Nothing Then
                    ...
                    If RbtInvoiceDirect.Checked Then
                        ClsMain.FGetItemRate(Dgl1.Item(Col1Item, mRow).Tag, Dgl1.Item(Col1RateType, mRow).Tag, TxtV_Date.Text, TxtSaleToParty.Tag, TxtSupplier.Tag, Dgl1.Item(Col1Rate, mRow).Value, Dgl1.Item(Col1RatePerQty, mRow).Value, Dgl1.Item(Col1RatePerMeasure, mRow).Value)
                    Else
    ...
    Private Sub Validating_Size(ByVal mRow As Integer)
        Dim DrTemp As DataRow() = Nothing
        Dim DtTemp As DataTable = Nothing
        Try
            If Dgl1.Item(Col1Size, mRow).Value.ToString.Trim = "" Or Dgl1.AgSelectedValue(Col1Size, mRow).ToString.Trim = "" Then
                Dgl1.Item(Col1MeasurePerPcs, mRow).Value = ""
            Else
                If Dgl1.AgDataRow IsNot Nothing Then
                    Dgl1.Item(Col1MeasurePerPcs, mRow).Value = AgL.XNull(Dgl1.AgDataRow.Cells("MeasurePerPcs").Value)
                    ...
                    mQry = " SELECT DecimalPlaces FROM Unit Where Code = '" & Dgl1.Item(Col1MeasureUnit, mRow).Value & "'  "
                    Dgl1.Item(Col1MeasureDecimalPlaces, mRow).Value = AgL.VNull(AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar)
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub Dgl1_EditingControl_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Dgl1.EditingControl_Validating
        ...
        Try
            ...
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                ...
                Case Col1RateType
                    ClsMain.FGetItemRate(Dgl1.Item(Col1Item, mRowIndex).Tag, Dgl1.Item(Col1RateType, mRowIndex).Tag, TxtV_Date.Text, TxtSaleToParty.Tag, TxtSupplier.Tag, Dgl1.Item(Col1Rate, mRowIndex).Value, Dgl1.Item(Col1RatePerQty, mRowIndex).Value, Dgl1.Item(Col1RatePerMeasure, mRowIndex).Value)

                Case Col1Size
                    Validating_Size(mRowIndex)
            End Select
            Call Calculation()
        Catch ex As Exception
            MsgBox(ex.Message)
        ...
        With Dgl1
            For I = 0 To .Rows.Count - 1
                If .Item(Col1Item, I).Value <> "" Then
                    ...
                    '    mQry = " SELECT IsNull(Sum(L.Qty),0) FROM SaleInvoiceDetail L WHERE L.SaleOrder = '" & Dgl1.Item(Col1SaleOrder, I).Tag & "' AND L.SaleOrderSr = " & Dgl1.Item(Col1SaleOrderSr, I).Value & " "
                    '    bInvoicedQty = AgL.VNull(AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar)
    ...
    Private Sub TxtBuyer_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtSaleToParty.KeyDown, TxtCurrency.KeyDown, TxtSalesTaxGroupParty.KeyDown, TxtBillToParty.KeyDown, TxtSupplier.KeyDown
        Try
            ...
            Select Case sender.name
                ...
                Case TxtSupplier.Name
                    If CType(sender, AgControls.AgTextBox).AgHelpDataSet Is Nothing Then
                        If e.KeyCode <> Keys.Enter Then
                            mQry = "SELECT Sg.SubCode As Code, Sg.Name + ',' + IsNull(C.CityName,'') As Supplier " & _
                                    " FROM SubGroup Sg " & _
                                    " LEFT JOIN City C ON Sg.CityCode = C.CityCode  " & _
            ...
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                Case Col1Item
                    If RbtInvoiceForChallan.Checked Then
                        ...
                        Dgl1.Columns(Col1ItemCode).ReadOnly = True
                    Else
                        Dgl1.Columns(Col1Item).ReadOnly = False
                        Dgl1.Columns(Col1ItemCode).ReadOnly = False
                    End If
    ...
    Private Sub FrmPurchInvoice_StoreItem_BaseEvent_Topctrl_tbPrn(ByVal SearchCode As String) Handles Me.BaseEvent_Topctrl_tbPrn
        ...
        '            " H.SaleToParty, H.SaleToPartyName, H.SaleToPartyAdd1, H.SaleToPartyAdd2,  " & _
        '            " H.SaleToPartyCity, H.SaleToPartyCityName, H.SaleToPartyState, H.SaleToPartyCountry, " & _
        '            " SG2.Mobile As SaleToPartyMobile ,SG2.EMail As SaleToPartyEMail, H.ShipToParty,  " & _
        '            " H.ShipToPartyName, H.ShipToPartyAdd1, H.ShipToPartyAdd2, H.ShipToPartyCity,  " & _
        '            " H.ShipToPartyCityName, H.ShipToPartyState, H.ShipToPartyCountry, H.Currency,  " & _
        '            " H.SalesTaxGroupParty, H.Structure, H.BillingType, H.ReferenceNo, H.PartyOrderNo,  " & _
        '            " H.PartyOrderDate, H.PartyDeliveryDate, H.PartyDeliveryTime, H.PartyOrderCancelDate,  " & _
        '            " H.TermsAndConditions, H.Remarks, H.TotalQty, H.TotalMeasure, H.StockTotalMeasure,  " & _
        '            " H.TotalAmount, H.SaleOrder, H.EntryBy, H.EntryDate, H.EntryType, H.EntryStatus,  " & _
        '            " H.ApproveBy, H.ApproveDate, H.MoveToLog, H.MoveToLogDate, H.IsDeleted, H.Status,  " & _
        '            " H.UID, H.DestinationPort, H.FinalPlaceOfDelivery, H.PreCarriageBy, H.PlaceOfReceipt,  " & _
        '            " H.ShipmentThrough, H.BankAcNoBuyer, H.BankNameBuyer, H.BankAddressBuyer, H.PriceMode,  " & _
        '            " H.Agent, H.CustomFields, H.Supplier, H.SaleToPartyMobile, H.ReferencePartyDocumentNo,  " & _
        '            " H.ReferencePartyDocumentDate, H.OrderType, H.ReferenceParty, " & _
        '            " L.DocId, L.Sr, L.Vendor, L.Item, L.Specification, L.PartySKU, L.PartyUPC,  " & _
        '            " L.SalesTaxGroupItem, L.Qty, L.Unit, L.MeasurePerPcs, L.MeasureUnit, L.TotalMeasure,  " & _
        ...
        '            " L.UID, L.DeliveryMeasure,  " & _
        '            " L.DeliveryMeasurePerPcs, L.TotalDeliveryMeasure,  " & _
        '            " L.Supplier, L.DeliveryMeasureMultiplier, " & _
        '            " Sg.DispName AS AgentName, Sg1.DispName AS SupplierName, I.Description AS ItemDesc, " & _
        '            " " & AgCalcGrid1.FLineTableFieldNameStr("H.", "H_") & " " & _
        '            " " & AgCustomGrid1.FHeaderTableFieldNameStr("H.", "H_") & " " & _
        '            " FROM (SELECT * FROM SaleOrder With (NoLock) WHERE DocId = '" & mSearchCode & "') AS H  " & _
        '            " LEFT JOIN (SELECT * FROM SaleOrderDetail With (NoLock) WHERE DocId = '" & mSearchCode & "') AS L ON H.DocID = L.DocId " & _
        '            " LEFT JOIN SubGroup Sg With (NoLock) ON H.Agent = Sg.SubCode " & _
        '            " LEFT JOIN SubGroup Sg1 With (NoLock) ON L.Supplier = Sg1.SubCode " & _
        '            " LEFT JOIN SubGroup Sg2 With (NoLock) On H.SaleTOParty = Sg2.SubCode " & _
        '            " LEFT JOIN Item I With (NoLock) ON L.Item = I.Code " & _
        ...
        '    "L.LotNo, L.UID, L.BusinessVolume, L.PointValue, L.BaleNo, L.Remark, " & _
            ...
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                ...
                Case Col1Size
                    If Dgl1.AgHelpDataSet(Col1Size) Is Nothing Then
                        mQry = " SELECT H.Code, H.Description, H.FeetArea As MeasurePerPcs, 'Sq.Feet' As MeasureUnit " & _
                                " FROM RUG_Size H " & _
                                " Where IsNull(H.Status,'" & AgTemplate.ClsMain.EntryStatus.Active & "') = '" & AgTemplate.ClsMain.EntryStatus.Active & "' "
        ...
        Try
            ...
            For I = 0 To DtLine.Rows.Count - 1
                ...
                If Val(Dgl1.Item(Col1Rate, I).Value) = 0 Then
                    ClsMain.FGetItemRate(Dgl1.Item(Col1Item, I).Tag, "", TxtV_Date.Text, TxtSaleToParty.Tag, TxtSupplier.Tag, Dgl1.Item(Col1Rate, I).Value, Dgl1.Item(Col1RatePerQty, I).Value, Dgl1.Item(Col1RatePerMeasure, I).Value)
                End If
            ...
            For I = 0 To Dgl1.Rows.Count - 1
                If Dgl1.Item(Col1SaleOrder, I).Tag <> "" And Dgl1.Item(Col1Item, I).Tag <> "" Then
                    ...
                    If TxtSupplier.Tag <> "" Then
                        mQry = " SELECT L.Supplier FROM SaleOrderDetail L WHERE L.DocId = '" & Dgl1.Item(Col1SaleOrder, I).Tag & "' AND L.Item = '" & Dgl1.Item(Col1Item, I).Tag & "' "
                        If AgL.XNull(AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar) <> TxtSupplier.Tag Then
                            ErrorLog += "Item """ & Dgl1.Item(Col1Item, I).Value & """ Does Not Belong To """ & TxtSupplier.Text & """ In Sale Order """ & Dgl1.Item(Col1SaleOrder, I).Value & """." & vbCrLf
                            Dgl1.Item(Col1ImportStatus, I).ToolTipText = "Item """ & Dgl1.Item(Col1Item, I).Value & """ Does Not Belong To """ & TxtSupplier.Text & """ In Sale Order """ & Dgl1.Item(Col1SaleOrder, I).Value & """." & vbCrLf
                            Dgl1.Item(Col1ImportStatus, I).Value = "Error"
                            ShowErrMsg = True
                        End If
                    End If
